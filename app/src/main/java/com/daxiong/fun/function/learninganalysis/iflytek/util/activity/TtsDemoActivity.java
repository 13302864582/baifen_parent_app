package com.daxiong.fun.function.learninganalysis.iflytek.util.activity;
...
import com.daxiong.fun.function.learninganalysis.iflytek.util.ApkInstaller;
...
public class TtsDemoActivity extends Activity implements View.OnClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mInstaller = new  ApkInstaller(TtsDemoActivity.this);
        }
        ...
        private void initLayout() {
            ...
            findViewById(R.id.image_tts_set).setOnClickListener(TtsDemoActivity.this);
        ...
        public void onClick(View view) {
            switch(view.getId()) {
                ...
                case R.id.tts_play:
                    // 移动数据分析，收集开始合成事件
                    FlowerCollector.onEvent(TtsDemoActivity.this, "tts_play");
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
        ...
        public void onResume() {
            //移动数据统计分析
            FlowerCollector.onResume(TtsDemoActivity.this);
        ...
        public void onPause() {
            ...
            FlowerCollector.onPause(TtsDemoActivity.this);
            super.onPause();
        }
