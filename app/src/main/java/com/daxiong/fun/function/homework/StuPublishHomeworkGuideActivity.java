...
public class StuPublishHomeworkGuideActivity extends BaseActivity implements OnViewClickListener {
...
//		slideClose = false;
		...
		page1.setBackgroundResource(R.drawable.start_publish_homework_guide_1);
		View page2 = inflater.inflate(R.layout.view_login_guide_layout, null);
		page2.setBackgroundResource(R.drawable.start_publish_homework_guide_2);
		View page3 = inflater.inflate(R.layout.view_login_guide_layout, null);
		page3.setBackgroundResource(R.drawable.start_publish_homework_guide_3);
		views.add(page1);
		views.add(page2);
		views.add(page3);

		vpAdapter = new GuidePageAdapter(this, views, GuidePageAdapter.GUIDE_TYPE_PUBLISH_HOMEWORK, this);
...
//        }else {
//           IntentManager.openActivityForResult(StuPublishHomeworkGuideActivity.this, PublishHomeWorkActivity.class, null, false, 1002);
//        }
...
//			startActivity(new Intent(this, StuPublishHomeWorkActivity.class));
//			
//			finish();
		    requestMyOrgs();
			break;
                            ...
                            if (!TextUtils.isEmpty(dataJson)) {
                                ...
                                if (isWaibao) {
                                    ...
                                    if (myOrgModel.getSpecialuser() != null&& myOrgModel.getSpecialuser().size() > 0) {                                        
                                        ...
                                        if (type == 1) {// 是特殊学生                                            
                                            ...
                                            if (listModels != null && listModels.size() > 0) {
                                                ...
                                                homeworkManager.goToOutsouringHomeWorkActivity(
                                                        StuPublishHomeworkGuideActivity.this, "", 0, listModels,type); 
                                            } else {
                                        ...
                                        homeworkManager.isVipOrg(this, dataJson);
                                        homeworkManager.goToOutsouringHomeWorkActivity(
                                                StuPublishHomeworkGuideActivity.this, "", 0, listModels,0); 
                                    }                                     
