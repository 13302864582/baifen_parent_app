 ...
 */
public class YizhifuOrderListAdapter extends BaseAdapter {

    private Context mContext;
    private List<MyOrderModel> orderList;

    public YizhifuOrderListAdapter(Context mContext, List<MyOrderModel> orderList) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.yizhifu_order_item_layout, null);
        ...
        holder.tvDateStr.setText(item.getServer_start_time()+"-"+item.getServer_end_time());

        holder.ivDelOrder.setVisibility(View.GONE);
        //取消操作
