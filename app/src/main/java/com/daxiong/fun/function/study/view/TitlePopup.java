package com.daxiong.fun.function.study.view;
...
import com.daxiong.fun.model.ActionItem;
...
public class TitlePopup extends PopupWindow {
	...
	//列表弹窗的间隔
	protected final int LIST_PADDING = 8;
	...
	public TitlePopup(Context context, int width, int height){
		...
		//获得屏幕的宽度和高度
		mScreenWidth = DensityUtil.getScreenWidth(mContext);
	...
	class  MyAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                convertView=View.inflate(mContext, R.layout.title_pupo_item, null);
...
//                holder.textView.setGravity(Gravity.CENTER);
                //设置文本域的范围
//                holder.textView.setPadding(-5,5, 0, 5);
                //设置文本在一行内显示（不换行）
...
//            holder.textView.setCompoundDrawablePadding(0);
            //设置在文字的左边放一个图标
//            holder.textView.setCompoundDrawablesWithIntrinsicBounds(item.mDrawable, null , null, null);
            holder.imageView.setImageDrawable(item.mDrawable);
            if (position==mActionItems.size()-1) {
