 ...
 * @author: sky
 */
public class CustomTipDialogWithNoButton extends Dialog {
    ...
    public CustomTipDialogWithNoButton(Activity context) {
    ...
    private void setCustomDialog(Context ctx) {
        View mView = View.inflate(ctx, R.layout.custom_tip_dialog_with_no_button, null);
