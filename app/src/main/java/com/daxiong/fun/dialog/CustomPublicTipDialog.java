 ...
 * @author: sky
 */
public class CustomPublicTipDialog extends Dialog {
    ...
    public CustomPublicTipDialog(Activity context, String title, String content, String leftBtnStr,
            String rightBtnStr) {
    ...
    private void setCustomDialog(Context ctx, String title, String content, String leftBtnStr,
            String rightBtnStr) {
        View mView = View.inflate(ctx, R.layout.custom_public_tip_dialog, null);
