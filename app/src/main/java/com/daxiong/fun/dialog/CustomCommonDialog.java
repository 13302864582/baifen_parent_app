...
public class CustomCommonDialog extends Dialog {
    ...
    public CustomCommonDialog(Activity context, String title, String message, String buttonLeftStr, String buttonRightStr) {
    ...
    private void setCustomDialog(Context ctx, String title, String message, String buttonLeftStr, String buttonRightStr) {
        View mCheckUpdateView = View.inflate(ctx, R.layout.layout_custom_common_dialog, null);
