...
public class CustomInputDialog extends Dialog {
    ...
    public CustomInputDialog(Activity context) {
    ...
    private void setCustomDialog(Context ctx) {
        View mView = View.inflate(ctx,R.layout.custom_input_dialog, null);
        title = (TextView) mView.findViewById(R.id.tv_title);
        editText = (EditText) mView.findViewById(R.id.tv_content);
