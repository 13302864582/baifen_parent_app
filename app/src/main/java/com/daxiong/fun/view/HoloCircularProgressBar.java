            ...
            try {
                ...
                setProgressBackgroundColor(attributes
                        .getColor(R.styleable.HoloCircularProgressBar_progress_background_color,
                                Color.GREEN));
                setProgress(
                        attributes.getFloat(R.styleable.HoloCircularProgressBar_progress_aa, 0.0f));
                setMarkerProgress(
...
//            mSquareRect.bottom = mThumbPosY + mThumbRadius / 3;
          //  canvas.drawRect(mSquareRect, mThumbColorPaint);
            canvas.drawCircle(mRadius, 0, mCircleStrokeWidth/2+4, mThumbColorPaint);
            canvas.restore();
        }
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        mRadius = halfWidth - drawedWith - 2.5f;
