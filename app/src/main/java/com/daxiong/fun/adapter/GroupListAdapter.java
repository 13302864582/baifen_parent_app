...
import com.daxiong.fun.view.ContactsListView;

public abstract class GroupListAdapter extends BaseAdapter implements
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (view instanceof ContactsListView) {
			((ContactsListView) view).configureHeaderView(firstVisibleItem);
		}
	}
	 ...
	 * call {@link ContactsListView#tellNoMoreData()} if there is no more pages.
	 * 
	 * @param page
