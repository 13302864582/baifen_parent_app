...
public class WebSocketConnection implements WebSocket {
			...
			if (mTransportChannel.isConnected()) {
				...
				try {
					...
					WebSocketMessage.ClientHandshake hs = new WebSocketMessage.ClientHandshake(
							mWsHost + ":" + mWsPort, mWsPath, "http://www.huoyanzuoye.com");//http://121.40.70.199:9000");
					//hs.mPath = mWsPath;
					hs.mQuery = mWsQuery;
   ...
   public void connect(String wsUri, WebSocket.ConnectionHandler wsHandler) throws WebSocketException {
	  Log.d("PushService", "----- connect method -----");
   ...
   private void onClose(int code, String reason) {
	   ...
	   if ((code == ConnectionHandler.CLOSE_NORMAL) || (code == ConnectionHandler.CLOSE_CANNOT_CONNECT) ||
