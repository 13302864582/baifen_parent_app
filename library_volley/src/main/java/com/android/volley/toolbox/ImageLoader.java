...
public class ImageLoader {
	 ...
	 *            loaded.
	 */
	public ImageContainer get(String requestUrl, final ImageListener listener, int imageSize, int roundSize) {
		return get(requestUrl, listener, 0, 0, imageSize, roundSize);
	}
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight,
		...
		// network and
		// track it.
		Request<Bitmap> newRequest = makeImageRequest(requestUrl, maxWidth, maxHeight, cacheKey, imageSize, roundSize);
